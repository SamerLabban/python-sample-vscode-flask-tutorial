[![Build Status](https://dev.azure.com/LabbanSamer/demo/_apis/build/status/SamerLabban.python-sample-vscode-flask-tutorial?branchName=master)](https://dev.azure.com/LabbanSamer/demo/_build/latest?definitionId=1&branchName=master)
